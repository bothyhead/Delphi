...
function! GetPascalIndent(lnum)
    ...
    " a begin? If the previous line is start with func/proc don't indent.
    " Otherwise if last line end with ";", we think this is the main
    " procedure, unindent it.  Otherwise the begin must is a part of if/while
    " etc., don't indent.
    if cline =~? '^\s*\<begin\>'
